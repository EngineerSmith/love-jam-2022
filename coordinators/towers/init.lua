...
wall:setStateTexture(tower.states.up, assets["tiles.walls.up"])
wall:setStateTexture(tower.states.down, assets["tiles.walls.down"])
wall:setStateTexture(tower.states.left, assets["tiles.walls.left"])
wall:setStateTexture(tower.states.right, assets["tiles.walls.down"])
