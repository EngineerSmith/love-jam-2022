...
return { 
    ...
    { "objects/towers/greencharging.png", "objects.towers.greencharging", onLoad = makePixelAnimation, 33, 64, 128, 0.035 },
    { "objects/towers/redcharging.png", "objects.towers.redcharging", onLoad = makePixelAnimation, 27, 64, 128, 0.035 },
    { "objects/towers/purplecharging.png", "objects.towers.purplecharging", onLoad = makePixelAnimation, 42, 64, 128, 0.035 },
